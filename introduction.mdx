...
Every API call requires a valid API key. You can retrieve the API key from an environment variable named `TRADDOCS_API_KEY` or provide it directly when initializing the TradDocs client.
