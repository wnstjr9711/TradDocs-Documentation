...
<ParamField path="fumigationDetails.place" type="string">
  Place where fumigation was performed
</ParamField>

<ParamField path="fumigationDetails.method" type="string">
  Method of fumigation
</ParamField>

<ParamField path="fumigationDetails.date" type="string">
  Date of fumigation
</ParamField>

<ParamField path="fumigationDetails.concentration" type="string">
  Concentration of the fumigant
</ParamField>

<ParamField path="fumigationDetails.exposureTime" type="string">
  Exposure time during fumigation
</ParamField>

<ParamField path="fumigationDetails.temperature" type="string">
