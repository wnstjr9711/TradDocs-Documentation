...
<ParamField path="documentNumber" type="string">
  Packing list document number
</ParamField>

<ParamField path="buyerReference" type="string">
  Buyer reference number
</ParamField>

<ParamField path="sellerReference" type="string">
...
<ParamField path="vesselDetails.vesselLiner" type="string">
  Vessel liner
</ParamField>
...
<ParamField path="packingPlace.name" type="string">
  Name of the packing place
</ParamField>

<ParamField path="packingPlace.address" type="string">
  Address of the packing place
</ParamField>

<ParamField path="packingDate" type="string">
  Packing date
</ParamField>
